"""
Django settings for IAmodels project.
...
SECRET_KEY = 'django-insecure-3#&pm__1+p%%9dd$q)^vz@z_k4(3a)(b*vp_gwsn@16z65&^9c'
...
WSGI_APPLICATION = 'IAmodels.wsgi.application'
